...
$DeptQuery = "SELECT * FROM dept WHERE DeptID = 'BUS'";
...
$deptemailQuery = "SELECT Email FROM dept WHERE DeptID = 'BUS'";
...
$deptphoneQuery = "SELECT PhoneNum FROM dept WHERE DeptID = 'BUS'";
...
$deptroomQuery = "SELECT RoomID FROM dept WHERE DeptID = 'BUS'";
...
// Fetching faculty in the BUS department including their emails from the logintable
// Fetching faculty in the BUS department including their emails and OfficeID
$facultyQuery = "SELECT 
    f.FacultyID, 
    f.FacultyType, 
...
<body>
    ...
    <main>
        <section>
            ...
            <p>Welcome to the <?php echo $DeptDetails['DeptName']; ?> Department at UA University! Our department is committed to offering a comprehensive education in business theories and practices, preparing our students for success in the dynamic world of business and entrepreneurship.</p>
