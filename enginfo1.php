...
// Fetching ENG department details
$DeptQuery = "SELECT * FROM dept WHERE DeptID = 'ENG'";
...
$deptemailQuery = "SELECT Email FROM dept WHERE DeptID = 'ENG'";
...
$deptphoneQuery = "SELECT PhoneNum FROM dept WHERE DeptID = 'ENG'";
...
$deptroomQuery = "SELECT RoomID FROM dept WHERE DeptID = 'ENG'";
...
// Fetching faculty in the ENG department including their emails from the logintable
// Fetching faculty in the ENG department including their emails and OfficeID from the facultyft and facultypf tables
$facultyQuery = "SELECT 
    f.FacultyID, 
    f.FacultyType, 
...
<body>
    ...
    <section>
            ...
            <p>Welcome to the <?php echo $DeptDetails['DeptName']; ?> Department at UA University! Our department is dedicated to exploring the depth and richness of English literature and language, encouraging critical thinking, and fostering a love for literary studies among our students.</p>
