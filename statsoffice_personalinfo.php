...
if (isset($_SESSION['UID'])) {
	...
	JOIN statsoffice ON user.UID = statsoffice.StatsID
	WHERE user.UID = '$uid'";
...
<div class="header">
   ...
   <div class="button-container">
       <a href="statsoffice_page1.php" class="btn">Back</a>
       </div>
</div>
...
<div class="academic-profile-container">
   ...
   <img src="profpic.jpg" alt="User Image" width="200">
	  ...
	  <p><strong>Client Name:</strong> <?php echo $user['ClientName']; ?></p>
	  <p><strong>Date Given Access:</strong> <?php echo $user['GAD']; ?></p>
</div>
