...
// Fetching PHY department details
$DeptQuery = "SELECT * FROM dept WHERE DeptID = 'PHY'";
...
$deptemailQuery = "SELECT Email FROM dept WHERE DeptID = 'PHY'";
...
$deptphoneQuery = "SELECT PhoneNum FROM dept WHERE DeptID = 'PHY'";
...
$deptroomQuery = "SELECT RoomID FROM dept WHERE DeptID = 'PHY'";
...
<body>
    ...
    <section>
            ...
            <p>Welcome to the <?php echo $DeptDetails['DeptName']; ?> Department at UA University! Our department is dedicated to the study of the fundamental laws of nature, fostering a deep understanding of the physical world through rigorous coursework, innovative research, and collaborative learning.</p>
             <ul>
