...
// Fetching PHI department details
$DeptQuery = "SELECT * FROM dept WHERE DeptID = 'PHI'";
...
$deptemailQuery = "SELECT Email FROM dept WHERE DeptID = 'PHI'";
...
$deptphoneQuery = "SELECT PhoneNum FROM dept WHERE DeptID = 'PHI'";
...
$deptroomQuery = "SELECT RoomID FROM dept WHERE DeptID = 'PHI'";
...
// Fetching faculty in the PHI department including their emails and OfficeID from the facultyft and facultypf tables
$facultyQuery = "SELECT 
    f.FacultyID, 
    f.FacultyType, 
...
<body>
    ...
    <section>
            ...
            <p>Welcome to the <?php echo $DeptDetails['DeptName']; ?> Department at UA University! Our department is dedicated to exploring the fundamental questions of existence, ethics, and knowledge. Join us in our pursuit of understanding the complexities of philosophical thought and its application in the modern world.</p>
