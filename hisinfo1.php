...
$DeptQuery = "SELECT * FROM dept WHERE DeptID = 'HIS'";
...
$deptemailQuery = "SELECT Email FROM dept WHERE DeptID = 'HIS'";
...
$deptphoneQuery = "SELECT PhoneNum FROM dept WHERE DeptID = 'HIS'";
...
$deptroomQuery = "SELECT RoomID FROM dept WHERE DeptID = 'HIS'";
...
// Fetching faculty in the HIS department including their emails from the logintable
$facultyQuery = "SELECT 
    f.FacultyID, 
    f.FacultyType, 
...
<body>
    ...
    <section>
            ...
            <p>Welcome to the <?php echo $DeptDetails['DeptName']; ?> Department at UA University! We are dedicated to exploring and understanding the complexities of the past, teaching our students how history shapes our present and future. Join us in uncovering the stories and events that have defined human experiences across time.</p>
