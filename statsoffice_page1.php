...
if (!isset($_SESSION['statsoffice_name'])) {
...
// Fetching additional ClientName information
...
<body>
   <div class="header">
      ...
      <div class="button-container">
         <a href="statsoffice_majors1.php" class="btn">Majors</a>
      </div>
      <div class="button-container">
         <a href="statsoffice_minor1.php" class="btn">Minors</a>
      </div>
      <div class="button-container">
         <a href="academiccal.html" class="btn">Academic Calendar</a>
      </div>
      <div class="button-container">
         <a href="statsoffice_course_catalog1.php" class="btn">Course Catalog</a>
      </div>
      <div class="button-container">
   ...
   <div class="welcome-statement">
    <p>Welcome, <?php echo $_SESSION['statsoffice_name']; ?>. Your UID is <?php echo $_SESSION['UID']; ?>. Welcome to UA University! As a Statistics Office representative, You represent <?php echo $clientname; ?>.</p>
   </div>
   ...
   <script>
      function searchAndFilterTable() {
        ...
        for (var i = 0; i < rows.length; i++) {
            ...
            var professorCell = row.getElementsByTagName('td')[8]; // Assuming Professor Name is in the 9th column
            if (professorCell) {
            ...
            var professoridCell = row.getElementsByTagName('td')[9]; // Assuming Professor ID is in the 10th column
            if (professoridCell) {
