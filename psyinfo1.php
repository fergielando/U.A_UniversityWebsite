...
// Fetching PSY department details
$DeptQuery = "SELECT * FROM dept WHERE DeptID = 'PSY'";
...
$deptemailQuery = "SELECT Email FROM dept WHERE DeptID = 'PSY'";
...
$deptphoneQuery = "SELECT PhoneNum FROM dept WHERE DeptID = 'PSY'";
...
$deptroomQuery = "SELECT RoomID FROM dept WHERE DeptID = 'PSY'";
...
// Fetching faculty in the PSY department including their emails and OfficeID
$facultyQuery = "SELECT 
    f.FacultyID, 
    f.FacultyType, 
...
<body>
    ...
    <section>
            ...
            <p>Welcome to the <?php echo $DeptDetails['DeptName']; ?> Department at UA University! Our department is focused on exploring the complexities of human behavior and mental processes, offering students a rich and diverse understanding of psychological theories and practices.</p>
              <ul>
