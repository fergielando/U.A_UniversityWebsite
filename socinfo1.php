...
// Fetching SOC department details
$DeptQuery = "SELECT * FROM dept WHERE DeptID = 'SOC'";
...
$deptemailQuery = "SELECT Email FROM dept WHERE DeptID = 'SOC'";
...
$deptphoneQuery = "SELECT PhoneNum FROM dept WHERE DeptID = 'SOC'";
...
$deptroomQuery = "SELECT RoomID FROM dept WHERE DeptID = 'SOC'";
...
// Fetching faculty in the SOC department including their emails and OfficeID
$facultyQuery = "SELECT 
    f.FacultyID, 
    f.FacultyType, 
...
<body>
    ...
    <section>
            ...
            <p>Welcome to the <?php echo $DeptDetails['DeptName']; ?> Department at UA University! Our department is dedicated to the study of social behavior, society's structures, and the complex relationships within communities. We provide students with a deep understanding of sociological concepts and research methodologies.</p>
              <ul>
