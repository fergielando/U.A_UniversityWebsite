...
// Fetching BIO department details
$DeptQuery = "SELECT * FROM dept WHERE DeptID = 'BIO'";
...
$deptemailQuery = "SELECT Email FROM dept WHERE DeptID = 'BIO'";
...
$deptphoneQuery = "SELECT PhoneNum FROM dept WHERE DeptID = 'BIO'";
...
$deptroomQuery = "SELECT RoomID FROM dept WHERE DeptID = 'BIO'";
...
// Fetching faculty in the BIO department including their emails from the logintable
// Fetching faculty in the BIO department including their emails and OfficeID
$facultyQuery = "SELECT 
    f.FacultyID, 
    f.FacultyType, 
