...
// Fetching MAT department details
$DeptQuery = "SELECT * FROM dept WHERE DeptID = 'MAT'";
...
$deptemailQuery = "SELECT Email FROM dept WHERE DeptID = 'MAT'";
...
$deptphoneQuery = "SELECT PhoneNum FROM dept WHERE DeptID = 'MAT'";
...
$deptroomQuery = "SELECT RoomID FROM dept WHERE DeptID = 'MAT'";
...
// Fetching faculty in the MAT department including their emails and OfficeID from the facultyft and facultypf tables
$facultyQuery = "SELECT 
    f.FacultyID, 
    f.FacultyType, 
...
<body>
    ...
    <section>
            ...
            <p>Welcome to the <?php echo $DeptDetails['DeptName']; ?> Department at UA University! Our department is committed to excellence in mathematical education and research, offering a rigorous curriculum and fostering a dynamic environment for exploring the vast world of mathematics.</p>
