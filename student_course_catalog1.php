...
<body>
   ...
   <div class="header">
      ...
      <h1>U.A. University Student Course Catalog</h1>
      <div class="buttons">
         <a href="user_page1.php" class="btn">Back to Student Portal</a>
      </div>
   </div>

   <div class="welcome-message">
      <p>Welcome, <?php echo $_SESSION['user_name']; ?>. This is the Course Catalog Page!</p>
   </div>
