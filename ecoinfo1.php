...
$DeptQuery = "SELECT * FROM dept WHERE DeptID = 'ECO'";
...
$deptemailQuery = "SELECT Email FROM dept WHERE DeptID = 'ECO'";
...
$deptphoneQuery = "SELECT PhoneNum FROM dept WHERE DeptID = 'ECO'";
...
$deptroomQuery = "SELECT RoomID FROM dept WHERE DeptID = 'ECO'";
...
// Fetching faculty in the ECO department including their emails and OfficeID from the facultyft and facultypf tables
$facultyQuery = "SELECT 
    f.FacultyID, 
    f.FacultyType, 
...
<body>
    ...
    <section>
            ...
            <p>Welcome to the <?php echo $DeptDetails['DeptName']; ?> Department at UA University! Our department is committed to providing a deep understanding of economic theories and practices, equipping our students with the analytical skills needed to excel in the global economic landscape.</p>
